...
author: 
  - "Sergio Garcia Mora | Yanel Paulette"
...
style_duo_accent(
  ...
  secondary_color = "#02D9D5",
  inverse_header_color = "#FFFFFF",
  header_font_google = google_font("Anton", "400"),
...
meta() %>%
  ...
  meta_social(
    title = "ATR",
    description = paste(
      "Esta es la presentación para la conferencia People Analytics World 2021 Latam sobre consejos sobre cómo empezar a programar en R y lograr avances en el aprendizaje",
      "Desarrollada por Sergio Garcia Mora y Yanel Paulette."
    ),
    url = "https://bit.ly/paw-la-r4hr-2021",
    image = "https://raw.githubusercontent.com/chechoid/paw-latam-2021/main/Archivos/portada.png",
    image_alt = paste(
      "Codear en R para RRHH: Una breve guía para aprender a programar y vivir para contarlo", 
      "Tucana's People Analytics World 2021 Latam", 
...
.pull-left[
Un día estaba explicando el método de clustering **de vecinos más cercanos** o **k-nn** por su nombre en inglés y usé este dibujo hecho en 

.center[<img src="clones/knn.jpg" width="40%" />]

Y después de hacerlo pensé *"esto lo podría hacer con datos"*.
...
.pull-left[
`r icons::fontawesome("link")` Presentación: [https://bit.ly/paw-la-r4hr-2021](https://bit.ly/paw-la-r4hr-2021)
...
`r icons::fontawesome("envelope")` [sergio.g.mora@dataiq.com.ar](mailto:sergio.g.mora@dataiq.com.ar)

`r icons::fontawesome("github")` [Repositorio de la presentación](https://github.com/chechoid/paw-latam-2021)
...
---
class: inverse, middle, center
# Agradecimientos, fuentes y créditos
...
`r emo::ji("red_heart")` Jesica y Jazmin por su constante apoyo y amor. 

`r emo::ji("100")` Barry Swales y a todos en Tucana por organizar un evento tan increíble.

`r emo::ji("gold")` Marta Gascón Corella por su generosidad y pensar en mí para ser parte del #PAWorld2021.

`r emo::ji("cheers")` La INCREIBLE comunidad de R de Latinoamérica y de todo el mundo.

`r emo::ji("hooray")` Cada uno de los que ha sido parte del Club de R para RRHH. No habría llegado tan lejos sin ustedes.

`r emo::ji("spock")` Mis mentores, Luis María Cravino y Tracey Smith: Son una gran fuente de inspiración y un motor para que esté en constante aprendizaje.
]